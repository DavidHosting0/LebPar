...
export function StickyWhatsApp({
  message = `Hi LebPar! I'd like to book a tandem paragliding flight in Jounieh.`,
}: Props) {
  ...
  return (
    <a
      ...
      aria-label="Book LebPar on WhatsApp"
    >
      <WhatsAppIcon />
...
export function WhatsAppLink({
  ...
  return (
    <a
      href={whatsappUrl(
        message ??
          `Hi ${siteConfig.name}! I'd like to book a tandem flight in Jounieh.`,
      )}
      target="_blank"
      rel="noopener noreferrer"
      className={className}
